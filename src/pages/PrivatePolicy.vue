<template>
    <div class="text-white w-11/12">
        ...
        <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Privacy Policy Generator</a>.</p>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Moto Jams.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Moto Jams, accessible from <a href="https://motojams.shop" rel="external nofollow noopener" target="_blank">https://motojams.shop</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: francis28adayo@yahoo.com</p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="motojams.shop/contact" rel="external nofollow noopener" target="_blank">motojams.shop/contact</a></p>
        </li>
        <li>
        <p>By phone number: 09561563326</p>
        </li>
        </ul>
    </div>
</template>
